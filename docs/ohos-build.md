...
- 独立 HAP 启动复验：当前 `build/ohos/hap/entry-default-signed.hap` SHA-256 为 `869DBB64358471AADA985A42C38E6DB54AB9F3C6A060826CCAD6E69C48FFAE47`；本轮源码已在 `127.0.0.1:5555` 安装并完成 ArkWeb smoke，`hdc install -r`、`aa force-stop`、`aa start` 均成功，`aa dump -a` 显示 `com.ohos.mgread` 的 `EntryAbility` 处于前台且 `READY`。
