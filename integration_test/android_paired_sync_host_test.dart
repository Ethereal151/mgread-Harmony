/// Android 端跨设备配对同步 Host，供 OHOS 真机发起方验收。
library;
...
void main() {
  ...
  testWidgets('Android host completes bidirectional HTTP sync with OHOS', (tester) async {
    ...
    final host = await PairedSyncHost.start(
      ...
      identityStore: CrossDeviceIdentityStore(crossDeviceAndroidIdentity, crossDeviceOhosIdentity.deviceId),
      discoveryPort: 0,
    ...
    debugPrint('MGREAD_CROSS_DEVICE_ANDROID_SUCCESS=true');
