...
var apiKey = "7961beb44246e3012ce228d6b5ced05a";
var apiVersion = "2.0.0";
var apiUserAgent = "Dart/3.5 (dart:io)";
var playerUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";
var maximumPage = 200;
var context;
var activeHost;
var authToken;
  ...
  return frozen({
    ...
    document: {
      components: [{
        ...
        subtitle: null,
        icon: target.kind === "rank" ? "ranking" : "video",
...
async function rootDiscovery(pageSize) {
  ...
  if (hotItems.length > 0) {
    components.push({
      type: "section",
      id: "huangdou-hot-section",
      title: "热门短剧",
      subtitle: null,
      icon: "hot",
      children: [{
        type: "contentCollection",
        id: collectionFor(hotTarget),
        layout: "coverGrid",
        items: hotItems,
  ...
  if (categories.length > 0) {
    components.push({
      type: "section",
      id: "huangdou-categories-section",
      title: "短剧频道",
      subtitle: null,
      icon: "video",
...
async function postAcrossHosts(path, data, token) {
  const hosts = activeHost === void 0 ? apiHosts : [activeHost, ...apiHosts.filter((host) => host !== activeHost)];
  let lastError;
