...
var channels = [{ id: "manju", title: "漫剧" }, { id: "rank_hot_play_comics", title: "漫榜" }, { id: "rank_hot_play_drama", title: "剧榜" }, { id: "rank_hot_search", title: "热搜榜" }];
var context;
...
async function getDetail(request) {
  ...
  return frozen({ ...summary(value, id), aliases: [], catalogUrl: `${root}detail?id=${encodeURIComponent(JSON.stringify({ cid: id }))}` });
}
