...
final class SourceVideoDataSource implements VideoEpisodeDataSource {
  ...
  Future<String> _resolveOhosHlsVariant(String masterUrl, Map<String, String> headers) async {
    ...
    try {
      ...
      // The native player can still handle a single variant playlist, and
      // keeping the original URL preserves compatibility with sources that
      // require a nonstandard request path for the master playlist.
      return masterUrl;
    } finally {
