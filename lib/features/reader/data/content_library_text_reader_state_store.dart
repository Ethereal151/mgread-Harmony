...
Map<String, Object?> _preferencesToMap(TextReaderPreferences value) => <String, Object?>{
  ...
  'pageTurnShortcuts': value.pageTurnShortcuts,
...
TextReaderPreferences _preferencesFromMap(Map<String, Object?> raw) {
  ...
  return TextReaderPreferences(
    ...
    brightnessMode: enumValue(ReaderBrightnessMode.values, raw['brightnessMode'], defaults.brightnessMode),
    ...
    pageTurnShortcuts: boolean('pageTurnShortcuts', defaults.pageTurnShortcuts),
